...
for i in range(57, 58):
    if __name__ == '__main__':
        ...
        write_features_tsv(ps, './outputfolder/cumulative_withintask/pruning_%d.tsv' % (i * pruning), featurelist=params.featurelist, id_prefix=False, require_valid = True)
